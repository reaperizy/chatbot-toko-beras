...
class _ChatBotScreenState extends State<ChatBotScreen> {
  ...
  void response(query) async {
    AuthGoogle authGoogle =
        await AuthGoogle(fileJson: "assets/crudential-chatbotnew.json")
            .build();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 10,
        title: const Text("Chatbot Toko Beras"),
      ),
      body: Column(
        children: <Widget>[
          Flexible(
                  ...
                  child: IconButton(
                      ...
                      onPressed: () {
                        if (messageInsert.text.isEmpty) {
                          ...
                          messageInsert.clear(); //yang bikin kosong tampilan inputan user saat berpindah halaman
                        }
                      }),
                )
              ],
